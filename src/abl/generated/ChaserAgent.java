...
public class ChaserAgent extends BehavingEntity {
   ...
   private static void registerBehaviors_0(BehaviorLibrary behaviorLibrary) {
      ...
      behaviorLibrary.registerBehavior(new __BehaviorDesc(8, __$behaviorFactory0_rfield, null, null, "move()", new String[] {"move()"}, null, (short)2));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(9, __$behaviorFactory0_rfield, __$precondition0_rfield, __$preconditionSensorFactory0_rfield, "seek_safety()", new String[] {"seek_safety()"}, null, (short)3));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(10, __$behaviorFactory0_rfield, null, null, "seek_safety()", new String[] {"seek_safety()"}, null, (short)2));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(11, __$behaviorFactory0_rfield, null, null, "Wait(int)", new String[] {"Wait(int)"}, null, (short)0));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(12, __$behaviorFactory0_rfield, null, null, "player_behavior()", new String[] {"player_behavior()"}, null, (short)0));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(13, __$behaviorFactory0_rfield, null, null, "creep_behavior()", new String[] {"creep_behavior()"}, null, (short)0));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(14, __$behaviorFactory0_rfield, null, null, "beginAction()", new String[] {"beginAction()"}, null, (short)0));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(15, __$behaviorFactory0_rfield, null, null, "player()", new String[] {"player()"}, null, (short)0));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(16, __$behaviorFactory0_rfield, null, null, "ChaserAgent_RootCollectionBehavior()", new String[] {"ChaserAgent_RootCollectionBehavior()"}, null, (short)0));
   }
   ...
   public ChaserAgent() {
      individualBehaviorLibrary = new BehaviorLibrary(34);
      ...
      ABT = (CollectionBehavior)ChaserAgent_BehaviorFactories.behaviorFactory0(16, null, null, null, "ChaserAgent_RootCollectionBehavior()");
