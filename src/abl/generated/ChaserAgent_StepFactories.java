...
public class ChaserAgent_StepFactories {
   static public Step stepFactory0(int __$stepID, Behavior __$behaviorParent, final Object[] __$behaviorFrame) {
      switch (__$stepID) {
         ...
         case 14: {
            // Wait_1Step2
            return new WaitStep(14, __$behaviorParent, false, false, false, false, false, false, (short)-32768, (short)0, false, null, null, ChaserAgent.__$successTest0_rfield, null, null);
         }
         case 15: {
            // player_behavior_1Step1
            return new GoalStep(15, __$behaviorParent, false, false, false, false, false, false, (short)-32768, (short)0, false, null, null, null, null, null, "manageFiring()", null, (short)0);
         }
         case 16: {
            // player_behavior_1Step2
            return new GoalStep(16, __$behaviorParent, false, false, false, false, false, false, (short)-32768, (short)0, false, null, null, null, null, null, "manageMovement()", null, (short)0);
         }
         case 17: {
            // creep_behavior_1Step1
            return new GoalStep(17, __$behaviorParent, false, true, false, false, false, false, (short)-32768, (short)0, false, null, null, null, null, null, "creep_fire()", null, (short)0);
         }
         case 18: {
            // beginAction_1Step1
            return new GoalStep(18, __$behaviorParent, false, false, false, false, false, false, (short)-32768, (short)0, false, null, null, null, null, null, "fire()", null, (short)0);
         }
         case 19: {
            // beginAction_1Step2
            return new GoalStep(19, __$behaviorParent, false, false, false, false, false, false, (short)-32768, (short)0, false, null, null, null, null, null, "move()", null, (short)0);
         }
         case 20: {
            // beginAction_1Step3
